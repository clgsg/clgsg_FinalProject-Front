...
// 				<HStack>
// 					<Checkbox value="3x3">3x3</Checkbox>
// 					<Checkbox value="baloncesto">Baloncesto</Checkbox>
// 					<Checkbox value="fútbol">Fútbol</Checkbox>
// 					<Checkbox value="fútbol 7">Fútbol 7</Checkbox>
// 					<Checkbox value="fútbol sala">Fútbol sala</Checkbox>
// 					<Checkbox value="pádel">Pádel</Checkbox>
// 					<Checkbox value="tenis">Tenis</Checkbox>
...
// 				<Button theme="theme" text="Borrar" to="" />
// 				<Button theme="theme" text="Buscar" to="/games/browse/results" />
// 			</ButtonGroup>
// 		</Stack>
// 	);
// }
